...
public class ContinueShoppingTest {
	...
	@When("the user selects the first carry-on luggage item")
	...
	@When("the user adds the item to the order for continue shopping")
	...
	@When("the user selects another carry-on luggage item")
	...
	@When("the user adds the second item to the order")
