...
public class SearchByCategoryTest {
	...
	@When("the User navigates to the women's perfume section")
	...
	@When("the User selects the perfume item")
	...
	@When("the User adds the item to the cart for categorysearch")
